...
/**
 * Created by liqu on 10/17/15.
 */
public class CollinearClientTest {


    @Test
    public void BruteTest() throws InterruptedException {
        System.out.println("BruteCollinearPoints Test");
